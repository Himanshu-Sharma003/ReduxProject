...
function forEach(obj, fn) {
  ...
  if ((typeof obj === 'undefined' ? 'undefined' : _typeof(obj)) !== 'object' && !isArrayLike) {
    obj = [obj];
  }
...
module.exports = function xhrAdapter(resolve, reject, config) {
  ...
  if (utils.isStandardBrowserEnv()) {
    ...
    var urlIsSameOrigin = __webpack_require__(40);
...
var _search_bar = __webpack_require__(31);

var _search_bar2 = _interopRequireDefault(_search_bar);

var _youtubeApiSearch = __webpack_require__(32);

var _youtubeApiSearch2 = _interopRequireDefault(_youtubeApiSearch);

var _video_list = __webpack_require__(43);

var _video_list2 = _interopRequireDefault(_video_list);

var _video_details = __webpack_require__(45);
...
var API_KEY = "AIzaSyABW48UetMSSlWuAv2t5nSQO-1BFRvBCKw";
...
var App = function (_Component) {
  ...
  function App(props) {
    ...
    (0, _youtubeApiSearch2.default)({ key: API_KEY, term: "cartoon" }, function (videos) {
      _this.setState({
        "videos": videos,
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_video_details2.default, { video: this.state.selectedVideo }),
        console.log("this.state.videos", this.state.videos),
        _react2.default.createElement(_video_list2.default, { onVideoSelect: function onVideoSelect(selectedVideo) {
            _this2.setState("selectedVideo");
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};if(process.env.NODE_ENV!=="production"){(function(){'use strict';var React=__webpack_require__(2);var invariant=__webpack_require__(6);var warning=__webpack_require__(7);var ExecutionEnvironment=__webpack_require__(9);var _assign=__webpack_require__(4);var emptyFunction=__webpack_require__(3);var EventListener=__webpack_require__(10);var getActiveElement=__webpack_require__(11);var shallowEqual=__webpack_require__(12);var containsNode=__webpack_require__(13);var focusNode=__webpack_require__(14);var emptyObject=__webpack_require__(5);var checkPropTypes=__webpack_require__(8);var hyphenateStyleName=__webpack_require__(27);var camelizeStyleName=__webpack_require__(29);/**
 * WARNING: DO NOT manually require this module.
 * This is a replacement for `invariant(...)` used by the error code system
 * and will _only_ be required by the corresponding babel pass.
 * It always throws.
    ...
    _createClass(SearchBar, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                null,
                'Search :',
                _react2.default.createElement('input', { value: this.state.term,
...
var _video_list_item = __webpack_require__(44);
...
var VideoList = function VideoList(props) {
  var videoItems = props.videos.map(function (value) {
    return _react2.default.createElement(_video_list_item2.default, { onVideoSelect: value.onVideoSelect, key: value.etag, video: value });
  });
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement("div", { className: "media-heading" }),
          video.snippet.title
        )
      )
    )
...
var VideoDetails = function VideoDetails(_ref) {
  var video = _ref.video;
